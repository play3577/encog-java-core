...
public class NEATPopulation extends BasicPopulation implements Serializable,
	 ...
	 */
	private double hyperNEATWeightRange = DEFAULT_HYPERNEAT_WEIGHT_RANGE;
	...
	public double getHyperNEATWeightRange() {
		return this.hyperNEATWeightRange;
	}
	...
	public void setHyperNEATWeightRange(final double hyperNEATWeightRange) {
		this.hyperNEATWeightRange = hyperNEATWeightRange;
	}
