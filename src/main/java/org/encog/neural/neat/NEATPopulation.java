...
public class NEATPopulation extends BasicPopulation implements Serializable,
	...
	private ActivationFunction hyperNEATNNActivationFunction = new ActivationBipolarSteepenedSigmoid();
	...
	public double getHyperNEATNNWeightRange() {
		return this.hyperNEATNNWeightRange;
	}
	...
	public void setHyperNEATNNWeightRange(final double hyperNEATNNWeightRange) {
		this.hyperNEATNNWeightRange = hyperNEATNNWeightRange;
	}
	...
	public ActivationFunction getHyperNEATNNActivationFunction() {
		return hyperNEATNNActivationFunction;
	}
